...
一般来说我们会把上述的代码放在body的最后，但是我们应该思考一个问题，就是这段js代码肯定会用到吗？答案是no，因为我们可以在用户点击分享的时候动态的加载js，所以有些问题我们能深入研究一下就可以知道一些高深的问题也不是很难懂
...
我们大家现在基本上都用到过webpack、gulp等自动化打包工具，他可以帮我们做很多东西，但是大家有没有了解他的具体细节那，他的懒加载和例子一是同样的原理
